...
$muziekstuk1 = new Muziekstuk("Yør kultura", "Willow", 105, "5:03 min" );
$muziekstuk2 = new Muziekstuk("Yør kultura", "Oak", 110, "7:10 min" );
$muziekstuk3 = new Muziekstuk("Stavroz", "Merci", 110, "7:10 min" );
